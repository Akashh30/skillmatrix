...
export default function DisplaySkillMapping() {
    ...
    const skillTypeOptions = [...new Set(mappings.map((item) => item.type_name))];
    const deptOptions = [...new Set(mappings.map((item) => item.department_name))];
    const schoolOptions = [...new Set(mappings.map((item) => item.school_name))];
